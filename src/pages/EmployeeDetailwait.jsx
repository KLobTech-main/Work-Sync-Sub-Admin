                ...
                {currentEmployees.map((employee) => (
                  <TableRow key={employee.id}>
                    ...
                    <TableCell>
                      ...
                      >
                        <MenuItem
                          onClick={() => handleActionSelect("showAllInfo")}
                        >
                          Show All Info
                        </MenuItem>
                        <MenuItem onClick={() => handleActionSelect("leave")}>
                          Leave
                        </MenuItem>
                        <MenuItem onClick={() => handleActionSelect("task")}>
                          Task
                        </MenuItem>
                        <MenuItem
              ...
              <Table>
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {selectedEmployee.addressDetails?.permanentAddress ||
                        "Not Available"}
                    </TableCell>
                  </TableRow>
                  <TableRow>
